                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center bg-light shadow rounded bg-color mt-3 mb-3 rounded g-1"
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="text-center my-3">
                                <button type="submit" className="btn btn-dark col-11 align-self-center mt-4">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>) : <div className="d-flex justify-content-center align-items-center flex-column h-100" style={{ minHeight: '100vh' }}>
                    <h2>El administrador del sistema ya fue registrado</h2>
                    <i className="fa-solid fa-user-shield" style={{ fontSize: '70px' }}></i>
                </div>
            }
        </div>
    )
